...
# ================== MESSAGE ==================
def create_message(price, structure_notes, bias):
    ...
    message = f"""XAUUSD M30 Setup — Intraday
...
if __name__ == "__main__":
    try:
        ...
        chart_file, notes, bias = create_chart(df)
        caption = create_message(price, notes, bias)
